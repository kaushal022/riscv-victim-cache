...
// P10 Implementation (Direct-Mapped L1 + Victim Cache)


module rv32i_top_p10 (
    input  wire        clk,
    input  wire        rst,
    ...
    (* mark_debug = "true", keep = "true" *) wire        cache_stall;
    ...
    (* mark_debug = "true", keep = "true" *) wire [31:0] hit_l1_count, hit_vc_count, miss_total_count, mem_access_count;
//  MEM Stage - Cache Subsystem 
    cache_subsystem CACHE (
        ...
        .hit_l1_count(hit_l1_count),
        .hit_vc_count(hit_vc_count),
        .miss_total_count(miss_total_count),
    ...
    mem_wb_reg MEM_WB (
        ...
        .pc_in(exmem_pc),               .pc_out(memwb_pc),
